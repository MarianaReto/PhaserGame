...
export default class secondScene extends Phaser.Scene {
    ...
    preload() {
        this.load.image("tiles2", "assets/secondlevel/tileset2.png");
        this.load.tilemapTiledJSON("secondlevel", "assets/secondlevel/level2.json");
    }
    ...
    createTilemap() {
        //creating level
        this.map = this.make.tilemap({ key: "secondlevel" });
        const tileset = this.map.addTilesetImage("tileset2", "tiles2");
        ...
        this.map.createStaticLayer("bg5", tileset, 0, 0);
        this.map.createStaticLayer("bg6", tileset, 0, 0);
        this.map.createStaticLayer("bg7", tileset, 0, 0);
        this.map.createStaticLayer("bg8", tileset, 0, 0);
    ...
    createCharacters() {
        ...
        this.protagonist = new Protagonist(this, 30, 130);
    ...
    update(time) {
        ...
        if(this.protagonist.x > 1560){
            this.sound.stopAll();
            this.scene.start("BossScene1");
        }
    }
